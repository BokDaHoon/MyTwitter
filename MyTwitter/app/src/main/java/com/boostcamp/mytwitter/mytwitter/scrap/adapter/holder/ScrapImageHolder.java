...
public class ScrapImageHolder extends RecyclerView.ViewHolder {
    ...
    @BindView(R.id.scrap_tweet_image)
    ImageView scrapTweetImage;
    ...
    public ScrapImageHolder(Context context, View itemView, OnItemClickListener listener) {
        super(itemView);
        mContext = context;
    ...
    public void onBind(final Cursor cursor, final int position) {
        ...
        if (cursor.moveToPosition(position)) {
            ...
            int tweetImageIndex = cursor.getColumnIndex(TwitterSchema.COLUMN_IMAGE_URL);
            ...
            final String tweetImage = cursor.getString(tweetImageIndex);
            ...
            scrapTweetImage.post(new Runnable() {
                @Override
                public void run() {
                    mGlideRequestManager
                            .load(tweetImage)
                            .into(scrapTweetImage);
                }
            });
