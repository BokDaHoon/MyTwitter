...
public class DaumSearchFragment extends Fragment implements SearchPresenter.View {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.from(getContext()).inflate(R.layout.fragment_daumsearch, container, false);
        naverSearchWordList = (RecyclerView) view.findViewById(R.id.daum_search_word_list);
    ...
    void init() {
        ...
        presenter.loadSearchWordList(Define.DAUM_SEARCH_FLAG);
